...
<header class="header-section index ">
    ...
    <form>
        <input type="hidden" name="girisForm" value="51e16ad21b69d0f6d0231d8142d1360ebaccb815c3a31927ad4faf70f3684f7b">
            ...
            <div class="row gy-5 gy-lg-0 align-items-center justify-content-between">
                <div class="col-12 col-lg-6">
                    <div class="section__content">
                        ...
                        <p class="section__content-text wow fadeInDown" data-wow-duration="0.8s">Welcome to Finview, your trusted resource for financial loan reviews and comparisons. Our dedicated team of experts analyzes various loan</p>
                        <div class="btn-group mt_40 wow fadeInUp" data-wow-duration="0.8s">
                            <a href="#calculator" class="btn_theme btn_theme_active">Loan Calculator<i class="bi bi-arrow-up-right"></i><span></span></a>
                            <a href="about.html" class="btn_theme">About us<i class="bi bi-arrow-up-right"></i><span></span></a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="feature_slider wow fadeInUp" data-wow-duration="0.8s">
                        <div class="card card--custom">
                            ...
                            <div class="card__content">
                                <h4 class="card__title"><a href="service-details.html">Loan Reviews</a></h4>
                                <p class="fs-small"> Provide comprehensive and unbiased reviews of various types of loans, including personal loans</p>
                                <a href="service-details.html" class="btn_theme social_box "><i class="bi bi-arrow-up-right"></i><span></span></a>
                            </div>
                        </div>
                        <div class="card card--custom">
                            <div class="card__icon">
                        ...
                        <div class="card card--custom">
                            ...
                            <div class="card__content">
                                <h4 class="card__title"><a href="service-details.html">Customer Support</a></h4>
                                <p class="fs-small">Provide informative articles, guides, and resources to educate users about different types of loans</p>
                                <a href="service-details.html" class="btn_theme social_box btn_bg_white"><i class="bi bi-arrow-up-right"></i><span></span></a>
                            </div>
                        </div>
                ...
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__content ms-lg-4 ms-xl-0">
                        ...
                        <div class="section__content-inner wow fadeInUp" data-wow-duration="0.8s">
                            <ul>
                                <li><i class="bi bi-check2-circle"></i> Comprehensive and Reviews</li>
                                <li><i class="bi bi-check2-circle"></i> Expert Guidance and Insights</li>
                                <li><i class="bi bi-check2-circle"></i> User-Friendly Comparison</li>
                                <li><i class="bi bi-check2-circle"></i> Trusted User Reviews</li>
                            </ul>
                        </div>
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-12">
                                <div class="section__cta wow fadeInUp" data-wow-duration="0.8s">
                                    <a href="loan-reviews.html" class="btn_theme see_all">See All Review Loan<i class="bi bi-arrow-up-right"></i><span></span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <form method="POST" autocomplete="off" id="frmCalculate" class="calculate__form">
                                        <div class="row gy-5 gy-md-0">
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="calculate__form-part">
                                                    <div class="input-single">
                                                        <label class="label" for="amount">Loan Amount <span>(required)</span></label>
                                                        <input type="number" class="form-control" name="amount" id="amount" placeholder="$0" required>
                                                    </div>
                                                    <div class="input-single">
                                                        <label class="label" for="year">Loan Term <span>(years)</span></label>
                                                        <input type="number" class="form-control" name="year" id="year" placeholder="0 years" >
                                                    </div>
                                                    <div class="input-single">
                                                        <label class="label" for="interest">Interest Rate (%) <span>(required)</span></label>
                                            ...
                                            <div class="col-12 col-md-6">
                                                ...
                                                <div class="calculate__form-part">
                                                    <div class="input-single">
                                                        <label class="label" for="amount2">Loan Amount <span>(required)</span></label>
                                                        <input type="number" class="form-control" name="amount2" id="amount2" placeholder="$0" required>
                                                    </div>
                                                    <div class="input-single">
                                                        <label class="label" for="year2">Loan Term <span>(years)</span></label>
                                                        <input type="number" class="form-control" name="year2" id="year2" placeholder="0 years" >
                                                    </div>
                                                    <div class="input-single">
                                                        <label class="label" for="interest2">Interest Rate (%) <span>(required)</span></label>
                                        ...
                                        <button type="submit" class="btn_theme btn_theme_active mt_40" name="calc_submit" id="calc_submit">Read More <i class="bi bi-arrow-up-right"></i><span></span></button>
                                    </form>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="calculate__form">
                                        <div class="row gy-5 gy-md-0">
                                            ...
                                            <div class="col-12 mt_32">
                                                ...
                                                <a href="about.html" class="btn_theme btn_theme_active mt_40">Back <i class="bi bi-arrow-up-right"></i><span></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
