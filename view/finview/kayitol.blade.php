            ...
            <div class="row gy-5 gy-xl-0 justify-content-center justify-content-lg-between align-items-center">
                <div class="col-12 col-lg-7 col-xxl-6">
                    <form method="POST" autocomplete="off" id="formkayitol" class="sign-up__form me-lg-4 me-xxl-0 wow fadeInUp"
                        ...
                        <p class="sign-up__sub-title mb_40">Hesabınız Var Mı? <a style="color: #00D9DA !important; "
                                href="">
                                Oturum Aç</a></p>
                        ...
                        <div class="form-check mt-2">
                            ...
                            <label class="form-check-label" for="">İfşanızda İsim ve Soyisminizin Görünmesini
                                İstemiyorsanız Rumuz Kullanabilirsiniz. Rumuz Kullanımını Aktif Etmek İçin Tıklayınız. İsim
                                ve Soy İsim Kayıt Esnasında Gereklidir. Rumuz Kullanımı İsteğe Bağlıdır.</label>
                        </div>
                        ...
                        <hr>
                        <button style="background-color: #3664A2 !important; border:#3664A2 !important;;" type="button"
                            class="btn_theme mt_32">Facebook ile Kayıt Ol<i
                                class="bi bi-arrow-up-right"></i><span></span></button>
