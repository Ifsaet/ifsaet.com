                ...
                <div class="col-12 col-sm-12">
                    <div class="banner__content mt-2">
                        <nav id="profilnavbar" aria-label="breadcrumb">
                            <a id="profilnavbara" href="index"><svg fill="#9399A1" width="25px" height="25px"
                                    viewBox="-6.4 -6.4 44.80 44.80" version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    stroke="#9399A1" stroke-width="0.64">
                            ...
                            <a id="profilnavbara" href="profil"><svg width="25px" height="25px" viewBox="0 0 24 24"
                                    fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#9399A1">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        <path d="M3 16.5L9 10L13 16L21 6.5" stroke="##9399A1" stroke-width="2"
                            ...
                            <a id="profilnavbara" href="ifsalarim"><svg width="25px" height="25px" viewBox="0 -0.5 25 25"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <path fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            stroke="#9399A1" stroke-width="1.5" stroke-linecap="round"
                            ...
                            <a id="profilnavbara" href="bildirimlerim"> <svg width="25px" height="25px"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        ...
                                        <g id="web-app" stroke="none" stroke-width="1" fill="none"
                                            fill-rule="evenodd">
        ...
        <div class="container">
            <div class="row gy-4 gy-lg-0">
                <div class="col-12 col-lg-7 col-xl-8">
                    <div class="gap-4 flex-column">
                        <div class="card card--secondary part wow fadeInUp" data-wow-duration="0.8s">
                            <form method="POST" autocomplete="off" id="frmContactus" class="sign-up__form">
                                <h3 class="contact__title">Profili Bilgileri</h3>
                                <hr>
                                <div class="sign-up__form-part">
                                    <div class="input-single">
                                        ...
                                        <input type="text" class="form-control" name="rumuz" id="rumuz"
                                            placeholder="Rumuz">
                                        <p style="font-size: 14px;">İfşalarınızda İsminizin Görünmesini İstemiyorsanız
                                            Rumuz Kullanabilirsiniz. Rumuz
                                            Kullanmak İstemiyorsanız Kutucuğu Boş Bırakabilirsiniz.</p>
                                        <button type="submit" class="btn_theme w-25" name="submit"
                    ...
                    <div class="gap-4 flex-column mt-5">
                        <div class="card card--secondary part wow fadeInUp" data-wow-duration="0.8s">
                            <form method="POST" autocomplete="off" id="frmContactus" class="sign-up__form">
                                <h3 class="contact__title">Parolanı Değiştir</h3>
                                <hr>
                                <div class="sign-up__form-part">
                                    <div class="input-single">
                                        <input type="password" class="form-control" name="mevcutsifre" id="mevcutsifre"
                                            placeholder="Mevcut Parolanız">
                                        <input type="password" class="form-control" name="yenisifre" id="yenisifre"
                                            placeholder="Yeni Parolanız">
                                        <input type="password" class="form-control" name="yenisifretekrar"
                                            id="yenisifretekrar" placeholder="Yeni Parola Tekrar">
                                        <button type="submit" class="btn_theme w-25" name="submit"
                                            id="submit">Kaydet<span></span></button>
                                    </div>
                                </div>
                ...
                <div class="col-12 col-lg-5 col-xl-4 ">
                    <div class="sidebar cus_scrollbar wow fadeInDown" data-wow-duration="0.8s">
                        <div style="background: #D63939 !important;" class="sidebar__part">
                            <a href="">
                                <div class="recent-posts">
                                    <div class="recent-posts__part justify-content-center">
                                        <div class="recent-posts__title text-center">
                                            <p style="color: white !important;">Şikayet yazabilmek için e-Posta adresinizi
                                                doğrulayın.</p>
                                        </div>
                                    </div>
                                </div>
