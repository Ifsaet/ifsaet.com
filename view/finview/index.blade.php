            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-12 col-lg-6 mt-5">
                    <div class="section__content" style="z-index: 4">
                        <h1 id="sliderh1" style="color:white !important; font-size:45px;" class="section__content-title display-3 wow fadeInUp" data-wow-duration="0.8s">Markaları <span style="color: #00d9da">Keşfedin</span> ve <span style="color: #FF8541">Yorumlayın!</span>
                        </h1>
                        <div class="search-box2">
                            <div class="row">
                                <input autocomplete="off" id="input-box2" class="form-control" style="height:60px; width:100%;" type="text" placeholder="Aradığın Kurum/Markayı Bul">
                            </div>
                    ...
                    <div id="sliderkart" class="container mt-3">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-xl-4 mt-2">
                                <div class="card card--custom wow fadeInUp" data-wow-duration="0.8s" style="padding: 5px; gap:1px;">
                                    <div class="card__icon mt-2">
                                        <svg width="45px" height="45px" viewBox="0 0 281.25 281.25" id="svg2" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://creativecommons.org/ns#" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns:svg="http://www.w3.org/2000/svg" fill="#000000" stroke="#000000"
                                                ...
                                                <g id="layer1" transform="translate(6402.3564,-4296.9987)">
                                                    <g id="g31697" transform="translate(-2269.2425,-389.12259)">
                                                        <path
                                                            ...
                                                            id="path8912" style="color:#000000;fill:#000000;fill-opacity:1;stroke-linecap:round;stroke-linejoin:round;-inkscape-stroke:none">
                                                        </path>
                                                        <path
                                                            ...
                                                            id="path9362" style="color:#000000;fill:#333333;fill-opacity:1;stroke-linecap:round;stroke-linejoin:round;-inkscape-stroke:none">
                                                        </path>
                                                    </g>
                                                </g>
                                            </g>
                            ...
                            <div class="col-12 col-sm-6 col-xl-4 mt-2">
                                <div class="card card--custom wow fadeInUp" data-wow-duration="0.8s" style="padding: 5px; gap:1px;">
                                    <div class="card__icon mt-2">
                                        <svg width="45px" height="45px" viewBox="0 0 32.00 32.00" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:sketch="http://www.bohemiancoding.com/sketch/ns" fill="#000000">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                        ...
                        <div class="row mt-3">
                            <div class="col-12 col-sm-6 col-xl-4 mt-2">
                                <div class="card card--custom wow fadeInUp" data-wow-duration="0.8s" style="padding: 5px; gap:1px;">
                                    <div class="card__icon mt-2">
                                        <svg fill="#000000" width="45px" height="45px" viewBox="0 0 1069 1069" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" version="1.1" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" xmlns:serif="http://www.serif.com/" xmlns:xlink="http://www.w3.org/1999/xlink">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
                                            </g>
                                            <g id="SVGRepo_iconCarrier">
                                                <rect height="1066.67" id="Chip-set" style="fill:none;" width="1066.67" x="1.397" y="0.245"></rect>
                                                <g>
                                                    <path
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-12 col-sm-6 col-xl-4 mt-2">
                                <div class="card card--custom wow fadeInUp" data-wow-duration="0.8s" style="padding: 5px; gap:1px;">
                                    <div class="card__icon mt-2">
                                        <svg fill="#000000" width="45px" height="45px" viewBox="0 0 200 200" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
                                            <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                                            <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round">
                                            </g>
                                            <g id="SVGRepo_iconCarrier">
                                ...
                                <div class="card card--custom wow fadeInUp" data-wow-duration="0.8s" style="padding: 5px; gap:1px;">
                                    <div class="card__icon mt-2">
                                        <svg width="45px" height="45px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <g id="SVGRepo_iconCarrier">
                                                <path d="M17 21V16M7 21V16" stroke="#000000" stroke-width="1.5" stroke-linecap="round"></path>
                                                <path
                                                ...
                                                <path d="M7 8C7 6.13077 7 5.19615 7.40192 4.5C7.66523 4.04394 8.04394 3.66523 8.5 3.40192C9.19615 3 10.1308 3 12 3C13.8692 3 14.8038 3 15.5 3.40192C15.9561 3.66523 16.3348 4.04394 16.5981 4.5C17 5.19615 17 6.13077 17 8V12H7V8Z" stroke="#000000" stroke-width="1.5"></path>
                                            </g>
                                        </svg>
                                    </div>
                                    <div class="card__content mt-2">
                ...
                <div id="sliderikincidiv" class="col-12 col-lg-6 col-xxl-5">
                    <div class="hero__thumb wow fadeInUp" data-wow-duration="0.8s">
                        <h1 style="color:white !important; font-size: 45px;">Hızlı Çözüm İçin <span style="color:#FF8541">İfşa Et</span></h1>
                        <div class="input-single mt-2">
                            <div style="display: grid; grid-template-columns: 1fr auto;">
                                <div style="display: grid; grid-template-columns: 1fr auto; align-items: center;">
                                    <label style="z-index:9; margin-right:5px;" class="label text-end"><a style=" color:white !important;" target="blank" href="https://www.youtube.com/watch?v=XZPezAinMo4&embeds_referring_euri=https%3A%2F%2Fwww.ifsaet.com%2F&source_ve_path=MjM4NTE&feature=emb_title&ab_channel=%C4%B0f%C5%9FaEt">Nasıl
                                            Yazılır?</a></label>
                            ...
                            <textarea style="z-index: 9; color:white;" class="form-control" id="message" name="message" rows="8" placeholder="Ürün veya hizmetle ilgili nasıl bir sorun yaşadınız?" required></textarea>
    ...
    <section id="gundemdekiifsalarsection" class="testimonials section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6 col-xxl-5">
                    <div class="section__header">
                        <h1 class="section__header-title wow fadeInUp" data-wow-duration="0.8s">Popüler İfşalar</h1>
                        <a style="color: white; font-size:25px;" href="#">Tümünü Görüntüle</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row gy-5 gy-lg-0 justify-content-between align-items-center">
                <div class="col-12 col-lg-4">
                    <div class="section__content">
                        ...
                        <a href="ifsaet" class="btn_theme btn_theme_active mt_40">İfşa Et<i class="bi bi-arrow-up-right"></i><span></span></a>
                    </div>
                </div>
                <div class="col-12 col-lg-6 mx-auto">
                    <div class="choose-us__thumb unset-xxl me-xl-4 me-xxl-0 wow fadeInDown" data-wow-duration="0.8s">
                        <iframe width="560" height="315" src="https://www.youtube.com/embed/XZPezAinMo4?si=JtgBeUISUpZtrx8Y" frameborder="0" allowfullscreen></iframe>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="working-process section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-12 col-lg-6 col-xxl-5">
                    <div class="section__header">
                        <h2 style="color: #FF8541 !important;" class="section__header-title wow fadeInUp" data-wow-duration="0.8s">Rakamlarla İfşa Et</h2>
                    </div>
                </div>
            </div>
            <div class="row g-2 g-md-4  wow fadeInUp" data-wow-duration="0.8s">
                        ...
                        <div class="card__icon">
                            <svg viewBox="-12 -12 48.00 48.00" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" stroke-width="0">
                                    <rect x="-12" y="-12" width="48.00" height="48.00" rx="24" fill="#00D9DA " strokewidth="0"></rect>
                                </g>
                    ...
                    <div class="card card--custom">
                        <div class="card__icon">
                            <svg viewBox="-12 -12 48.00 48.00" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <path d="M20.91 11.12C20.91 16.01 17.36 20.59 12.51 21.93C12.18 22.02 11.82 22.02 11.49 21.93C6.63996 20.59 3.08997 16.01 3.08997 11.12V6.72997C3.08997 5.90997 3.70998 4.97998 4.47998 4.66998L10.05 2.39001C11.3 1.88001 12.71 1.88001 13.96 2.39001L19.53 4.66998C20.29 4.97998 20.92 5.90997 20.92 6.72997L20.91 11.12Z" stroke="#ffffff" stroke-width="1.2"
                                        stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M12 12.5C13.1046 12.5 14 11.6046 14 10.5C14 9.39543 13.1046 8.5 12 8.5C10.8954 8.5 10 9.39543 10 10.5C10 11.6046 10.8954 12.5 12 12.5Z" stroke="#ffffff" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <path d="M12 12.5V15.5" stroke="#ffffff" stroke-width="1.2" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"></path>
                                </g>
                            </svg>
                ...
                <div class="col-12 col-sm-6 col-xxl-3">
                    <div class="card card--custom">
                        <div class="card__icon">
                            <svg fill="#ffffff" viewBox="-32 -32 128.00 128.00" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" xmlns:serif="http://www.serif.com/" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:2;" stroke="#ffffff" stroke-width="3.2">
                                <g id="SVGRepo_bgCarrier" stroke-width="0">
                                    <rect x="-32" y="-32" width="128.00" height="128.00" rx="64" fill="#00D9DA" strokewidth="0"></rect>
                                </g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    <rect id="Icons" x="-512" y="-64" width="1280" height="800" style="fill:none;"></rect>
                                    <g id="Icons1" serif:id="Icons">
                                        ...
                                        <g id="hr"> </g>
                                        <path id="success" d="M56.103,16.824l-33.296,33.297l-14.781,-14.78l2.767,-2.767l11.952,11.952l30.53,-30.53c0.943,0.943 1.886,1.886 2.828,2.828Z" style="fill-rule:nonzero;"></path>
                                        <g id="info"> </g>
                                        <g id="warning"> </g>
                                        <g id="plus-circle"> </g>
                                        <g id="minus-circle"> </g>
                ...
                <div class="col-12 col-sm-6 col-xxl-3">
                    <div class="card card--custom">
                        <div class="card__icon">
                            <svg viewBox="-12 -12 48.00 48.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000">
                                <g id="SVGRepo_bgCarrier" stroke-width="0">
                                    <rect x="-12" y="-12" width="48.00" height="48.00" rx="24" fill="#00D9DA" strokewidth="0"></rect>
                                </g>
                                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                <g id="SVGRepo_iconCarrier">
                                    ...
                                    <path d="M15 12C15 13.6569 13.6569 15 12 15C10.3431 15 9 13.6569 9 12C9 10.3431 10.3431 9 12 9C13.6569 9 15 10.3431 15 12Z" stroke="#ffffff" stroke-width="1.224"></path>
                                </g>
                            </svg>
                        </div>
                        <div class="card__content">
            ...
            <div class="row gy-5 gy-xl-0 justify-content-center justify-content-xxl-between align-items-center">
                <div class="col-12 col-lg-8 col-xxl-8">
                    <div class="section__content ms-xl-4 ms-xl-0">
                        <h2 id="birliktecalisalim" style="color: white !important;" class="section__content-title wow fadeInUp" data-wow-duration="0.8s">Markanızın çözüm ortağı:
                            İfşa Et
                        </h2>
