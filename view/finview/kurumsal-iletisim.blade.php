        ...
        <div class="container">
            <div class="row gy-5 gy-xl-0 justify-content-center">
                <div class="col-8 col-lg-8 col-xxl-8">
                    <form method="POST" autocomplete="off" class="sign-up__form wow fadeInDown" data-wow-duration="0.8s">
                        <h3 class="contact__title wow fadeInDown text-center" data-wow-duration="0.8s">Kurumsal İletişim Formu
                        </h3>
                        <div class="sign-up__form-part">
                            <div class="input-single">
                                <input type="text" class="form-control" name="marka" id="marka" placeholder="Marka"
                                    required>
                            </div>
                            <div class="input-single">
                        ...
                        <button type="submit" class="btn_theme btn_theme_active mt-3" name="gonder"
                            id="gonder">Gönder<i class="bi bi-arrow-up-right"></i><span></span></button>
                    </form>
                </div>
            </div>
        </div>
