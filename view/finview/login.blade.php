                    ...
                    <form method="POST" autocomplete="off" id="loginform" class="sign-up__form me-lg-4 me-xxl-0">
                        ...
                        <div class="sign-up__form-part mt-5">
                            <div class="input-single">
                                <input type="email" class="form-control" name="user" id="user" placeholder="E-Posta Adresinizi Girin">
                            </div>
                            <div class="input-single">
                                <div class="input-pass">
                                    <input type="password" class="form-control" name="pass" id="pass" placeholder="Şifrenizi Girin">
                        ...
                        <span id="msg"></span>
                        <button type="button" class="btn_theme mt_32" name="login" id="login">Giriş Yap<i class="bi bi-arrow-up-right"></i><span></span></button>
                    </form>
                </div>
