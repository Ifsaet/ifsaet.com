            ...
            <div class="row gy-4 gy-sm-0 align-items-center">
                ...
                <div class="col-12 col-sm-6">
                    <div class="banner__thumb text-end">
                        <img src="assets/finview/images/faq_banner.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-center">
                <div class="col-12 col-lg-7 col-xxl-6">
                    <div class="section__header">
                        <p class="section__header-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img src="assets/finview/images/title_vector.png" alt="vector">Frequently Asked Questions</p>
            ...
            <div class="row gy-5 gy-xl-0 justify-content-center justify-content-xxl-between align-items-center">
                <div class="col-12 col-lg-6 col-xxl-6">
                    <div class="section__content ms-xl-4 ms-xl-0">
                        <span class="section__content-sub-title headingFour wow fadeInDown" data-wow-duration="0.8s"><img src="assets/finview/images/title_vector.png" alt="vector"> Start Your Loan Search Today</span>
                        ...
                        <a href="contact.html" class="btn_theme btn_theme_active mt-3 wow fadeInDown" data-wow-duration="0.8s">Contact Us <i class="bi bi-arrow-up-right"></i><span></span></a>
                    </div>
                </div>
                <div class="col-12 col-sm-8 col-md-6 col-xxl-5">
                    <div class="loan-solution__thumb unset-xxl wow fadeInDown" data-wow-duration="0.8s">
                        <img src="assets/finview/images/loan_solution.png" alt="image">
                    </div>
                </div>
            </div>
        </div>
